...
<<'agouti-mouse'>>=
#agouti <- "https://upload.wikimedia.org/wikipedia/commons/4/4d/Agouti_Mice.jpg"
@

\begin{figure}
\includegraphics[height=6cm]{figs/Agouti.jpg}
\caption{https://upload.wikimedia.org/wikipedia/commons/4/4d/Agouti\_Mice.jpg}
\label{fig:agouti}
\end{figure}
...
<<encircle, fig.cap = "Two-dimensional grid of ordered pairs of markers.">>=
